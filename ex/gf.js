...
function moveCrab() {
    ...
    //if (keyIsDown(17)) { // СTRL НЕ РАБОТАЕТ (-_-)
        //if(!(keyIsDown(65) || keyIsDown(97)||keyIsDown(68)||KeyIsDown(100))){
           // drawCrabSit(crabX,crabY);
       // }
    //}
    ...
    /*for (let i=0, i<200 , i++){ НЕ РАБОТАЕТ
        if (!(keyIsDown(parseInt(i)))&&(crabY==500)){//если ничего не нажато
        drawCrabStand(crabX,crabY);
    }
    }
    */
