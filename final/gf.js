...
function preload() {
    ...
    unmuteIcon = loadImage("images/unmute.png",
...
function drawGame() {
    ...
    let iconSize = 60;
    let currentIcon = isMuted ? muteIcon : unmuteIcon;
    image(currentIcon, (width - iconSize)/2, 10, iconSize, iconSize);
}
...
function mousePressed() {
    if (currentScreen === 'game') {
        ...
        // Проверяем клик по иконке звука
